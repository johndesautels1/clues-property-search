...
🟡 FIRING ORDER: You are the 3rd data source in the search chain.
TIER 3 DATA SOURCES (already ran BEFORE you):
...
You ONLY search for fields that Tier 3 sources did NOT find.
