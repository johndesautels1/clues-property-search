...
| 2 | **Gemini** | `gemini-3-pro` | ✅ Google Search grounding | 4 | 85% |
...
TIER 4: Web-Search LLMs (cascade order)
   ...
   ├── #2 Gemini - gemini-3-pro (Google Search grounding)
...
| `callGeminiForecast` | multi-llm-forecast.ts | 610 | gemini-3-pro |
