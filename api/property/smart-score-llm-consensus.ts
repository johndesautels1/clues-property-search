...
// ============================================
const GROK_SMART_SCORE_SYSTEM_PROMPT = `🚨 OUTPUT JSON ONLY. NO CONVERSATIONAL TEXT. START YOUR RESPONSE WITH { AND END WITH }.
...
### REASONING PROTOCOL
1. METRIC CORRELATION: Compare the 47 high-velocity fields (AVMs, Market Performance, Permits, Features) to determine "Market Momentum."
2. VARIANCE ANALYSIS: Calculate the delta between the Subject's 'Price per Sqft' (Field 92) and the Comps.
3. FRICTION IDENTIFICATION: If Field 174 (Homes Under Contract) is high but Field 95 (Days on Market) is also high, identify this as a "Price-to-Condition Mismatch."
